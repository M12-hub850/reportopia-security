  ...
  ar: {
    ...
    stats: {
      ...
      monthlyVisits: {
        ...
        description: "زيارات المدير للمشروع هذا الشهر"
      },
      incidents: {
    ...
    cards: {
      managerVisits: {
        ...
        subtitle: "متابعة أداء المشروع",
        description: "إنشاء ومتابعة تقارير الزيارات الشهرية وتحليلها",
        action: "إضافة تقرير جديد"
      },
      supervisorVisits: {
        title: "زيارات المشرف الأسبوعية",
        subtitle: "متابعة التفتيش والملاحظات",
      ...
      incidents: {
        ...
        description: "توثيق ومتابعة الأحداث والحوادث الأمنية مع التفاصيل الكاملة",
        action: "إضافة تقرير جديد"
      },
      vehicles: {
      ...
      archive: {
        ...
        subtitle: "الوصول لجميع التقارير",
